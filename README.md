...
<p align="center">
  <strong><a href="https://github.com/hughleat/tiro/releases/download/v0.1.0-beta.6/Tiro-0.1.0-beta.6-6-macOS-arm64.dmg">Download Tiro Public Beta (.dmg, 6.1 MB)</a></strong>
...
1. [Download beta 6](https://github.com/hughleat/tiro/releases/download/v0.1.0-beta.6/Tiro-0.1.0-beta.6-6-macOS-arm64.dmg), open the DMG, and drag Tiro to Applications.
...
[release page](https://github.com/hughleat/tiro/releases/tag/v0.1.0-beta.6), then
run:

```sh
shasum -a 256 ~/Downloads/Tiro-0.1.0-beta.6-6-macOS-arm64.dmg
```
